...
const INSTAGRAM_URL = 'https://www.instagram.com/avmsmiledesign/';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        <div className="mt-16 sm:mt-20 text-center flex flex-wrap items-center justify-center gap-4">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-8 py-5 sm:px-10 sm:py-6 bg-[#E1306C] text-white text-[11px] font-bold uppercase tracking-[0.2em] hover:bg-[#C13584] transition-all rounded-sm focus:outline-none focus:ring-2 focus:ring-[#E1306C] focus:ring-offset-2"
          >

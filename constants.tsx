...
export const SERVICES: ServiceCard[] = [
  ...
  },
  {
    ...
    features: ['Mejoría instantánea en la calidad de la piel', 'Efecto Tensor', 'Larga Duración'],
  ...
  },
  {
    ...
    price: '$1.140.000 COP',
    priceUsd: 'USD 271',
    description: 'Perfilamiento de labios, voluminización e hidratación labial. Suavizado de líneas de expresión. Resultados naturales y armónicos.',
  ...
  },
  {
    ...
    features: ['Tecnología Avanzada', 'Piel Radiante', 'Protocolo AVM', 'PDNR'],
    ctaText: 'Agendar Valoración VIP en Cali',
  ...
  },
  {
    ...
    price: '$400.000 COP',
    priceUsd: 'USD 95',
    description: 'Hidratación profunda, aporte de vitaminas y minerales. El complemento premium para tu piel.',
